    ...
    public void prisvoeniePoley(Igra igra, List<String> innerList) {
        ...
        switch (time / 60) {
            ...
            case 9:
                ...
                break;
            default:
                if (igra.zamokResult && time < 720) { //todo повторня проверка ненужна вроде по твемен // когда более 10 минут или  10 то кладеться результат а так же когда менее одной
